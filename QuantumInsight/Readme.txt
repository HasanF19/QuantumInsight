...
Prototype_V1.py
→ Simulates a single quantum circuit and interprets it with an agent like “Measurement Analyst.” Review this to get familiar with the system.
...
Prototype_V7.py
→ The project’s “finished,” most powerful version. Combines the nested circuit and multi-agent workflow in a single file. Continue with this file.
...
- **app.py**  
  → Streamlit tabanlı web arayüzü. Yan panelden qubit sayısını ve tekrar sayısını seçip “Simülasyonu Çalıştır” butonuyla komple sistemi çalıştırır (Terminalden takip edebilirsiniz).
...
- **NumPy**: Rastgele parametre üretimi, sayı işlemleri.  
- **Matplotlib**: Ölçüm histogramlarını grafik olarak çizme.  
...
komut satırından gelişmiş algoritmayı kullanmak için:
--->python Prototype_V7.py

Arayüze ulaşıp basitleştirilmiş agent yorumlarına ulaşmak için:
--->python -m streamlit run app.py


Her sorunuz için ulaşabilirsiniz
ozturkhasanfatih@gmail.com
